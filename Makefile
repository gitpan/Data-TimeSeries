# This Makefile is for the Data::TimeSeries extension to perl.
#
...
#     ABSTRACT_FROM => q[TimeSeries.pm]
#     AUTHOR => q[tj <tj@localdomain>]
#     NAME => q[Data::TimeSeries]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[TimeSeries.pm]
...
DISTNAME = Data-TimeSeries
NAME_SYM = Data_TimeSeries
VERSION = 0.50
VERSION_SYM = 0_50
XS_VERSION = 0.50
...
FULLEXT = Data/TimeSeries
BASEEXT = TimeSeries
PARENT_NAME = Data
DLBASE = $(BASEEXT)
VERSION_FROM = TimeSeries.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
TO_INST_PM = TimeSeries.pm \
	TimeSeries/ChronoKey.pm

PM_TO_BLIB = TimeSeries/ChronoKey.pm \
	blib/lib/Data/TimeSeries/ChronoKey.pm \
	TimeSeries.pm \
	blib/lib/Data/TimeSeries.pm
...
manifypods : pure_all TimeSeries.pm
	@$(POD2MAN) \
	TimeSeries.pm \
	$(INST_MAN3DIR)/Data::TimeSeries.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/Data/TimeSeries/ChronoKey.pm blib/lib/Data/TimeSeries.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0,50,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT></ABSTRACT>\n\t<AUTHOR>tj &lt;tj\@localdomain&gt;</AUTHOR>\n}" > $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{TimeSeries/ChronoKey.pm blib/lib/Data/TimeSeries/ChronoKey.pm TimeSeries.pm blib/lib/Data/TimeSeries.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
